...
<div class="min-h-screen min-w-full flex flex-col md:flex-row  ">
    ...
    <div
        ...
        <div>
            ...
            <div class=" my-6 flex justify-center align-middle flex-wrap bg-red-500">
                <h2 class="w-full">Welcome, {{ $student->student_fname }}!</h2>
                <img src="{{ $student->student_picture }}" class="w-24" alt="">
                <form class="w-full">
